...
<body>
    ...
    ">
        ...
        <div class="mb-3 mt-3">
            <p>Don't have an account? <a href="register.php" style="color:#e8491d;">Register</a>
               <!-- <p>Forgot Password? <a href="resetpassword.php" style="color:#e8491d;">Reset password</a> -->
        </form>
    </div>
    </body>        
</html>